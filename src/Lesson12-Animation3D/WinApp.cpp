...
void WinApp::Initialize(int width, int height,const char*title)
{
	...
	m_pModelStd.Load("model/Animation3d.sm");            // 加载模型
	m_pModelStd.LoadKeyFrame("model/Animation3d.kfkey"); // 加载关键帧
...
{	
	...
	// 绘制模型
	m_pModelStd.Render(deltaTime, m_ThirdCamera, m_ShaderDirLight);
